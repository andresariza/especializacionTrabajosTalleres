...
public class Cita{
    ...
    public String toString(){
        return "  Descripci�n: " + descripcion + FIN_DE_LINEA +
            "  Inicio de la Reuni�n: " + fechaInicial + FIN_DE_LINEA +
            "  Fin de la reuni�n: " + fechaFinal + FIN_DE_LINEA +
            "  Ubicaci�n: " + ubicacion + FIN_DE_LINEA +
